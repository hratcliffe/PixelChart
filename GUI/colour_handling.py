...
from SharedData.types import ImageStatePayload, ImageChangePayload, ImageCombinePayload, ImageEnhancePayload
...
def fill_colour_combos(window):
  ...
  window.emphasize_select.addItem("Bright", 'i')
  window.emphasize_select.addItem("Shade", 's')
  window.emphasize_select.addItem("Bold", 't') #sTrong colour
